...
name: create-skill
user-invocable: true
description: '**WORKFLOW SKILL** — Guide users through creating reusable SKILL.md files by extracting workflows from conversation history. USE FOR: capturing multi-step processes, debugging methodologies, implementation patterns into skills. DO NOT USE FOR: creating other customization files (use agent-customization); general coding tasks. INVOKES: ask-questions tool (clarify requirements), file system tools (create SKILL.md files).'
---
