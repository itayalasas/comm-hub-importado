        ...
        <div className="space-y-10">
          ...
          <Section icon={<Globe className="w-5 h-5 text-cyan-400" />} title="3. Compartición de datos con terceros">
            ...
            <div className="space-y-4">
              {[
                {
                  name: 'Supabase (base de datos y autenticación)',
                  detail: 'Nuestros datos están almacenados en infraestructura de Supabase (PostgreSQL). Aplica su política de privacidad.',
