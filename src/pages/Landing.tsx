      ...
      <div className="w-full lg:w-1/2 relative flex flex-col justify-between p-8 sm:p-14 pb-36 lg:pb-14 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="slide-3 space-y-3">
            {[
              { icon: Shield, title: 'Seguridad Avanzada', desc: 'Autenticacion empresarial con altos estandares de seguridad.' },
              { icon: ArrowRight, title: 'Acceso Rapido', desc: 'Inicia sesion en segundos con tu cuenta empresarial.' },
              { icon: Check, title: 'Gestion Unificada', desc: 'Administra comunicaciones, templates y analitica desde un solo lugar.' },
            ...
            <div className="p-10">
              ...
              <div className="slide-4 bg-white/[0.03] border border-white/8 rounded-xl p-6 mb-8">
                ...
                <ul className="space-y-3">
                  {[
                    'Maxima seguridad con encriptacion avanzada.',
