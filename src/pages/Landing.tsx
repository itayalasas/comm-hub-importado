        ...
        <div className="relative z-10">
          <div className="flex items-center space-x-3 mb-8 sm:mb-16">
            <div className="relative">
              ...
              <img src="/logo.svg" alt="CommHub" className="h-8 sm:h-10 relative" />
            </div>
          ...
          <div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold mb-1">Acceso Rápido</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold mb-1">Gestión Unificada</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">
