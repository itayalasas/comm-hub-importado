...
export const Layout = ({ children, currentPage }: LayoutProps) => {
  ...
  const allNavItems: NavItem[] = ([
    ...
    },
    {
      ...
      permissionKey: 'automatizaciones',
      children: [
        { name: 'Programados', icon: CalendarClock, route: 'automatizaciones/programados', page: 'automatizaciones-programados', permissionKey: 'automatizaciones.programados' },
        { name: 'En lote', icon: Send, route: 'automatizaciones/en-lote', page: 'automatizaciones-en-lote', permissionKey: 'automatizaciones.en_lote' },
        { name: 'Monitoreo', icon: Activity, route: 'automatizaciones/monitoreo', page: 'automatizaciones-monitoreo', permissionKey: 'automatizaciones.monitoreo' },
      ],
    },
    {
      name: 'Documentación',
